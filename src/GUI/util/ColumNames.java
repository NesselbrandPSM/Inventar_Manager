...
public class ColumNames {
    ...
    public static final String[] allAttributesPR = new String[]{
            ...
            "Equipment Nummer", "Serien Nummer", "Status", "DGUV", "IP-Addresse", "Bemerkung", "Zustand", "Zustandsbemerkung"
    };
    ...
    public static final String[] allAttributesMO = new String[]{
            "Primärschlüssel", "Inventar Nummer", "Hersteller", "Firma", "Modell", "Auflösung", "Kaufdatum", "KaufPreis","Garantie", "Status", "DGUV", "Serien Nummer", "HDMI", "DisplayPort", "DVI", "VGA", "Bemerkung", "Zustand", "Zustandsbemerkung"
    };
    ...
    public static final String[] allAttributesHD = new String[]{
            "Primärschlüssel", "Inventar Nummer", "Hersteller", "Firma", "Modell", "Nutzer", "Nutzer Email", "Kaufdatum", "KaufPreis","Garantie", "Status", "DGUV", "Serien Nummer", "Bemerkung", "Zustand", "Zustandsbemerkung"
    };
    ...
    public static final String[] allAttributesDK = new String[]{
            ...
            "Bemerkung", "Zustand", "Zustandsbemerkung"
    };
}