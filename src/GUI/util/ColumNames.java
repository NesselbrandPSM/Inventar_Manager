...
public class ColumNames {
    ...
    public static final String[] allAttributesPR = new String[]{
            "Primärschlüssel", "Inventar Nummer", "Hersteller", "Modell", "Firma", "Kaufdatum", "KaufPreis","Garantie",
            "Equipment Nummer", "Serien Nummer", "Status", "DGUV", "IP-Addresse", "Bemerkung"
    };

    public static final String[] allAttributesSC = new String[]{
            "Primärschlüssel", "Inventar Nummer", "Hersteller", "Firma", "Modell", "Nutzer", "Nutzer Email", "Kaufdatum", "KaufPreis", "Garantie","Status", "DGUV", "Serien Nummer", "IP-Addresse", "Bemerkung"
    };

    public static final String[] allAttributesMO = new String[]{
            "Primärschlüssel", "Inventar Nummer", "Hersteller", "Firma", "Modell", "Auflösung", "Kaufdatum", "KaufPreis","Garantie", "Status", "DGUV", "Serien Nummer", "HDMI", "DisplayPort", "DVI", "VGA", "Bemerkung"
    };
    ...
    public static final String[] allAttributesHD = new String[]{
            "Primärschlüssel", "Inventar Nummer", "Hersteller", "Firma", "Modell", "Nutzer", "Nutzer Email", "Kaufdatum", "KaufPreis","Garantie", "Status", "DGUV", "Serien Nummer", "Bemerkung"
    };
